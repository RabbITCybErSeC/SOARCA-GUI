...
func LoginBaseLayout() templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var4 := templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
			...
			_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("<body class=\"min-h-screen bg-gray-100 dark:bg-slate-800 flex flex-col justify-center sm:py-12 font-family-sans-seri\"><div class=\"p-10 xs:p-0 mx-auto md:w-full md:max-w-md\"><h1 class=\"text-center text-2xl mb-5 font-semibold uppercase\"></h1><div class=\"bg-white shadow w-full rounded-lg divide-y divide-gray-200\"><div id=\"extra-information\" class=\"px-5 py-7\"></div><div class=\"bg-white shadow w-full rounded-lg divide-y divide-gray-200\">")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
